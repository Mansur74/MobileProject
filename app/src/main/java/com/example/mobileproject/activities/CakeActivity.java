...
public class CakeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cakeList = findViewById(R.id.cake_list);
        cakes = new ArrayList<>();

        adapter = new CakeAdapter(CakeActivity.this, cakes);
        ...
        JsonObjectRequest
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            for(int i=0; i <  response.getJSONArray("cakes").length(); i++)
                            {
                                ...
                                Cake cake = new Cake(name, ingredients, layer, price, img_url);
                                cakes.add(cake);
                            }
